...
<div class="panel-body">
	<div class="form-group">
		<label class="col-sm-3 control-label text-right"><spring:message
				code="lbl.upload.edcr.master" /><span class="mandatory"></span></label>
		<div class="col-sm-4 add-margin">
			<div class="fileSection col-md77-4">
				<input type="file" required="required" name="xlsxFile" id="xlsxFile"
					style="display: none;">
				<p class="hide">
			...
			<small class="text-info view-content"><spring:message
					code="lbl.dcr.upload.master.help" /></small>
		</div>
	</div>
	<%-- <div class="form-group">
		<div>
