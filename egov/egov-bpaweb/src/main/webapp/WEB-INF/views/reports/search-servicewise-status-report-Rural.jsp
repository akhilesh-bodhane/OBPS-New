...
<form:form role="form" action=""
	modelAttribute="searchBpaApplicationForm" id="serviceTypeWiseStatusReportRural"
...
<div class="row display-hide ss-rural-report-section" id="table_container">
	<div class="col-md-12 form-group report-table-container">
		<table class="table table-bordered table-hover multiheadertbl"
			id="searchStatusByServiceTypeReportRuralTable">
			<thead>
				<tr>
...
<script src="<cdn:url value='/resources/js/app/servicewise-status-report-helper-chart-Rural.js?rnd=${app_release_no}'/> "></script>
