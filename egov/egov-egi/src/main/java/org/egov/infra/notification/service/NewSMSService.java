...
public class NewSMSService {
	 ...
	 * @param templateid
	 *            : 12 to 19 digit id for each template content
	...
	public String sendSingleSMS(String username, String password,
		...
		try {
			// context=SSLContext.getInstance("TLSv1.1"); // Use this line for
			// Java version 6
			context = SSLContext.getInstance("TLSv1.2"); // Use this line for
															// Java version 7
															// and above
