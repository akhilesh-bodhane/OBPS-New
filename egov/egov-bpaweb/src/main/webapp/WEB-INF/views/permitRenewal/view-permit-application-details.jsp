...
<div class="panel-heading">
	<div class="panel-title">
		<div class="panel-title">
			<spring:message code="lbl.permit.appln.dtl" />
		</div>
	</div>
</div>
...
<div class="panel-body">
	<div class="row add-border">
		...
		<div class="col-sm-3 add-margin view-content">
			<a target="popup"
				onclick="window.open('/bpa/application/details-view/by-permit-number/${permitRenewal.parent.planPermissionNumber}','popup','width=1100,height=700'); return false;">${permitRenewal.parent.planPermissionNumber}</a>
		</div>
		<div class="col-sm-3 add-margin">
			<spring:message code="lbl.edcr.number" />
		</div>
		<div class="col-sm-3 add-margin view-content">
			<c:out value="${permitRenewal.parent.eDcrNumber}" default="N/A"></c:out>
		</div>
	</div>
	<div class="row add-border">
		<div class="col-sm-3 add-margin">
	...
	<div class="row add-border">
		...
		<div class="col-sm-3 add-margin view-content">
			<c:out value="${permitRenewal.parent.owner.name}" default="N/A"></c:out>
		</div>
		<div class="col-sm-3 add-margin">
			<spring:message code="lbl.owner.address" />
		</div>
		<div class="col-sm-3 add-margin view-content">
			<c:out value="${permitRenewal.parent.owner.address}"></c:out>
		</div>
	</div>
	<div class="row add-border">
		<div class="col-sm-3 add-margin">
		...
		<div class="col-sm-3 add-margin view-content">
			<c:out
				value="${permitRenewal.parent.stakeHolder[0].stakeHolder.stakeHolderType.name}"
				default="N/A"></c:out>
		</div>
		<div class="col-sm-3 add-margin">
		...
		<div class="col-sm-3 add-margin view-content">
			<c:out
				value="${permitRenewal.parent.stakeHolder[0].stakeHolder.name}"></c:out>
		</div>
	</div>
	<div class="row add-border">
		<div class="col-sm-3 add-margin">
		...
		<div class="col-sm-3 add-margin view-content">
			<c:out value="${permitRenewal.parent.occupanciesName}" default="N/A"></c:out>
		</div>
		<div class="col-sm-3 add-margin">
			<spring:message code="lbl.service.type" />
		</div>
		<div class="col-sm-3 add-margin view-content">
			<c:out value="${permitRenewal.parent.serviceType.description}"
				default="N/A"></c:out>
		</div>
	</div>
