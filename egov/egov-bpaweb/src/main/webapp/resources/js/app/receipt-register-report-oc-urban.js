 ...
 */
 ...
 $('#btnSearch').click(function() {
		var isValid = false;
		$('#receiptRegisterReportOC').find(':input', ':select', ':textarea').each(function() {
			if ($(this).val()) {
				isValid = true;
				return false;
			} else
 ...
 function callAjaxSearch() {
        ...
        buttons: [{
            extend: 'pdf',
            title: 'Occupancy Certificate Receipt Register Report',
            filename: 'Occupancy_Certificate_Receipt_Register_Report',
