...
<head>
    ...
    <script src="<cdn:url value='/resources/global/js/jq/jq.js' context='/egi'/>" type="text/javascript"></script>
...
<script src="<cdn:url value='/resources/global/js/bts/bts.js' context='/egi'/>" type="text/javascript"></script>
