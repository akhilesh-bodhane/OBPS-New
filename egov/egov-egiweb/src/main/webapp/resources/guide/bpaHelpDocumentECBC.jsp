...
<body style="padding-top:0px; min-height: 100vh; display: flex; flex-direction: column;">
		...
		<div class="card landingpage-card landingpage-card-video">
			<div class="card-content collapsible-header landingpage-card-content">
				<span class="card-title card-header card-subheader"
					...
					Chandigarh Energy Conservation Building Code 2024 </span>
			</div>
			<div class="is-flex services-item">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 services"
					style="display: block;">
					<a
						href="/egi/resources/guide/assets/docs/ECBC NotificationCode.pdf">
						<div class="content a" style="height: 42px;">Chandigarh Energy Conservation Building Code - 2024 (CHECBC-2024)</div>
					</a>
				</div>
			</div>
			<div class="is-flex services-item">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 services"
					style="display: block;">
					<a
						href="/egi/resources/guide/assets/docs/EEBC Rules Gazette Notification.pdf">
						<div class="content a" style="height: 42px;">CHANDIGARH ENERGY CONSERVATION BUILDING CODE RULES, 2024 (Gazette Notification)</div>
					</a>
				</div>
			</div>
		</div>
	...
	<footer
		class="f-regular bpa-login-footer page-common-padding col-md-12 color-black" style="bottom:0;margin-top: auto;">
